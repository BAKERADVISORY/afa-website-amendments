...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://www.ausfinancialadvisory.com.au/services/small-business-restructure/',
  },
  openGraph: {
    title: 'Small Business Restructuring Gold Coast QLD | SBR Practitioners',
    description:
        ...
        <div style={{ maxWidth: 1400, margin: '0 auto', padding: '0 32px' }}>
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 64, alignItems: 'center' }}>
            ...
            <div>
              ...
              <h2 style={{ fontSize: 36, fontWeight: 700, color: '#383838', marginBottom: 16, lineHeight: 1.25 }}>
                Is Your Business Eligible?
              </h2>
              <p style={{ fontSize: 16, color: '#666666', lineHeight: 1.6, marginBottom: 28 }}>
                The SBR process has specific eligibility requirements. Check if your business qualifies:
              </p>
      ...
      <section style={{ backgroundColor: '#f5f5f5', padding: '80px 0' }}>
        <div style={{ maxWidth: 1400, margin: '0 auto', padding: '0 32px' }}>
          ...
          <p style={{
            ...
            SBR is a formal insolvency process that offers a lifeline for struggling small businesses, providing a structured pathway to recovery while maintaining business control.
          </p>
      ...
      <section style={{ backgroundColor: '#111111', padding: '80px 0' }}>
        <div style={{ maxWidth: 1400, margin: '0 auto', padding: '0 32px' }}>
          ...
          <p style={{
            ...
            We guide you through every step of the Small Business Restructuring process to ensure the best possible outcome for your business.
          </p>
