...
export const metadata: Metadata = {
  ...
  description:
    'Close your company correctly and protect yourself from personal liability. Advisory and referral for directors across Gold Coast and Australia.',
  alternates: {
      ...
      <main>
        ...
        >
          ...
          >
            ...
            >
              When it&apos;s time to close your business, ensure it&apos;s done
              properly. Our expert team handles every aspect of company closure
        ...
        <section style={{ backgroundColor: '#FFFFFF', padding: '80px 0' }}>
          <div style={{ maxWidth: 1400, margin: '0 auto', padding: '0 32px' }}>
            ...
            >
              Comprehensive company closure solutions ensuring legal and
          ...
          <div style={{ maxWidth: 1400, margin: '0 auto', padding: '0 32px' }}>
            ...
            >
              ...
              <div>
                ...
                >
                  Improper company closure can leave you exposed to ongoing
                  liabilities, tax issues, and regulatory problems. Our
                  professional approach helps minimise risk and ensures the
                  process is handled correctly and in line with all legal
                  obligations.
                </p>
                <ul
                  style={{
        ...
        <section style={{ backgroundColor: '#FFFFFF', padding: '80px 0' }}>
          <div style={{ maxWidth: 900, margin: '0 auto', padding: '0 32px' }}>
            ...
            >
              ...
              >
                Directors can be held personally liable for unpaid taxes and
                employee entitlements if company closure is not handled
                properly. Don&apos;t risk your personal assets &mdash; let our
                experts handle your company closure with the care and attention
                it deserves.
              </p>
              <a
                href="/#contact"
