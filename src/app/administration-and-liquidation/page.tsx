      ...
      <main style={{ paddingTop: 80 }}>
        ...
        >
          ...
          >
            ...
            >
              Administration and liquidation do not have to happen to you.
              Choose your path before someone else chooses it for you — because
              who is in control of the process matters enormously.
            </p>
            <a
              href="/#contact"
              style={{
        ...
        <section style={{ backgroundColor: '#ffffff', padding: '80px 0' }}>
          <div style={{ maxWidth: 1100, margin: '0 auto', padding: '0 32px' }}>
            <div style={{ maxWidth: 700, marginBottom: 48 }}>
              ...
              >
                We Help You Understand Your Position Before Committing to
                Anything
              </h2>
              <p
                style={{
              ...
              >
                When formal insolvency processes are on the table, the decisions
                you make in the next days or weeks will shape everything that
                follows. We make sure you understand what each option means for
                you as a director — before you commit to a path.
              </p>
            </div>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 32 }}>
              ...
              >
                ...
                >
                  If your company needs to be wound up, this is the most
        ...
        <section style={{ backgroundColor: '#111111', padding: '80px 0' }}>
          ...
          >
            ...
            >
              The earlier you act, the more control you have over what happens
              next. The discovery call is free, confidential, and carries no
              obligation.
            </p>
            <a
              href="/#contact"
