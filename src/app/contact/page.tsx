    ...
    <>
      ...
      <section style={{
        ...
        <div style={{ maxWidth: 1400, margin: '0 auto', position: 'relative', zIndex: 1 }}>
          ...
          <p style={{ fontSize: 18, color: 'rgba(255,255,255,0.7)', maxWidth: 600, lineHeight: 1.6, marginBottom: 32 }}>
            Ready to take the next step? Contact our expert team for a confidential consultation about your business needs. We&apos;re here to help.
          </p>
          <a
            href="/contact/"
            style={{
      ...
      <section style={{ backgroundColor: '#FFFFFF', padding: '80px 0' }}>
        <div style={{ maxWidth: 1400, margin: '0 auto', padding: '0 32px' }}>
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 420px', gap: 64 }}>
            ...
            {/* Left: Contact Form */}
            <div>
              <h2 style={{ fontSize: 36, fontWeight: 800, color: '#383838', marginBottom: 12 }}>
                Send Us a Message
              </h2>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 24 }}>
              ...
              <div style={{ backgroundColor: '#17243B', borderRadius: 12, padding: 24 }}>
                ...
                <p style={{ fontSize: 14, color: 'rgba(255,255,255,0.7)', lineHeight: 1.6, marginBottom: 20 }}>
                  If you&apos;re facing an immediate business crisis such as creditor pressure, legal notices, or time-sensitive financial matters, contact us immediately.
                </p>
                <a
                  href="tel:1300052321"
                  style={{
