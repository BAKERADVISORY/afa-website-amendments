          ...
          <div style={{ maxWidth: 860, margin: '0 auto' }}>
            ...
            <div style={{
              ...
              <p style={{ fontSize: 15, color: '#444', lineHeight: 1.8, margin: '12px 0 0' }}>
                <strong style={{ color: '#17243B' }}>Directors:</strong> Jonathan Moy and Jason Baker
              </p>
            </div>
              ...
              },
              {
                ...
                custom: (
                  <p style={{ fontSize: 15, color: '#555', lineHeight: 1.8, margin: 0 }}>
                    ...
                    <a href="mailto:info@australianfinancialadvisory.com.au" style={{ color: '#0C9488', textDecoration: 'none', fontWeight: 600 }}>
              ...
              },
              {
                ...
                custom: (
                  <p style={{ fontSize: 15, color: '#555', lineHeight: 1.8, margin: 0 }}>
                    ...
                    <a href="https://www.oaic.gov.au" target="_blank" rel="noopener noreferrer" style={{ color: '#0C9488', textDecoration: 'none', fontWeight: 600 }}>
                      www.oaic.gov.au
                    </a>
                  </p>
                ),
